...
import { Separator } from "@Konect U -resume/ui";
  ...
  <footer className="bg-background">
    ...
    <div className="container grid py-12 sm:grid-cols-3 lg:grid-cols-4">
      <div className="flex flex-col gap-y-2">
        ...
        <h2 className="text-xl font-medium">{t`Konect U  Resume`}</h2>
      ...
      <div className="relative col-start-4 flex flex-col items-end justify-end">
        <div className="mb-14 space-y-6 text-right">
          <a
            className="block"
            href="https://www.digitalocean.com/?utm_medium=opensource&utm_source=Konect U -Resume"
          >
            <img

...
export const PrivacyPolicyPage = () => (
  <main className="relative isolate bg-background">
    <Helmet prioritizeSeoTags>
      <title>
        {t`Privacy Policy`} - {t`Konect U  Resume`}
      </title>
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using Konect U  Resume, you
        ...
        <li>
          ...
          <p>
            Konect U  Resume is committed to ensuring the security of your data. Our application and
